...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="document/properties/authors">
  </xsl:template>
  ...
  <xsl:template match="document/properties/subtitle">
  ...
  <xsl:template match="document/body/section/section/section/section/section">
    <xsl:call-template name="section">
      <xsl:with-param name="hashes">####</xsl:with-param>
      <xsl:with-param name="title">
        <xsl:value-of select="title"/>
  ...
  <xsl:template match="blockquote|note|warning">
  ...
  <xsl:template match="thead|colgroup|col">
    <xsl:apply-templates select="@*|node()"/>
  </xsl:template>
  ...
  <xsl:template match="img|figure|icon[@src]">
    <xsl:text> ![</xsl:text>
