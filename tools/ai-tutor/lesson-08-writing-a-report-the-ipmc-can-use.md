...
**On the headings.** The Reporting Guide describes the sections; the live report
page phrases them as questions and carries several more. The live page says the
headings change from time to time and that you should not copy an old report. So
this lesson teaches what each section is for and refuses to be a substitute for
