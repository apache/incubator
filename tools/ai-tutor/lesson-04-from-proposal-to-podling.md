...
# System prompt: Lesson 4 tutor ("From proposal to podling")
...
**On the knowledge base.** This lesson draws on three Incubator wiki pages, all
built from real proposal threads, plus the proposal template as it is actually
used. The template is the spine: its section names are what a proposer fills in
and what reviewers read, and its Known Risks headings turn out to be the same
list of concerns the three guides describe from the reviewers' side.

**On the boundary with Lesson 1.** Lesson 1 covered whether a community wants
incubation at all, and gave the journey in outline. This lesson does not
re-argue that. It starts from a community that has decided, and covers the part
between deciding and being voted in.

**On what is left to later lessons.** Infrastructure setup is Lesson 5, vote
mechanics are Lesson 6, growing committers after entry is Lesson 7, reporting is
Lesson 8, licensing and IP detail is Lesson 9, and naming and trademarks are
Lesson 10. This lesson touches all of them because a proposal has to, and goes
into none of them.
