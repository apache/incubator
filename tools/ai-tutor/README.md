...
| [12. Anatomy of a podling release](lesson-12-anatomy-of-a-podling-release.md) | D, Releases | What counts as a release and what does not, what a source package must contain and what a convenience binary may be, signing, checksums and KEYS, where artifacts live from staging to archive, and what is different because the project is a podling. | ~35 min |
| [13. Running a release vote](lesson-13-running-a-release-vote.md) | D, Releases | Chaining the two stages and what must travel between them, calling a vote a reviewer can act on, the arithmetic of majority approval, who binds where, answering review feedback, and closing the vote so the record is usable. | ~35 min |
| [14. Announcing and distributing](lesson-14-announcing-and-distributing.md) | D, Releases | The order between a passed vote and a sent announcement, where a release lives and what happens automatically, what a download page must contain, what an announcement must link and never point at, the other channels projects publish to, and correcting what is already out. | ~35 min |
| [15. What a mentor actually does](lesson-15-what-a-mentor-actually-does.md) | E, Mentoring | What a mentor is accountable for and to whom, what they do not do, becoming a mentor, the first weeks, when to watch and when to step in, reports and sign-off, escalation, conflict of interest, and judging your own engagement. | ~35 min |
| [16. Reading the signals](lesson-16-reading-the-signals.md) | E, Mentoring | What the red flags are and are not, reading a podling report, measuring health without scoring it, the four mentor-podling archetypes, and why a signal is evidence to check rather than a verdict to deliver. | ~35 min |
| [17. Difficult conversations](lesson-17-difficult-conversations.md) | E, Mentoring | Behaviours rather than people, questions before assertions, the eight named situations and their pitfalls, where a conversation belongs, when it is not a wording problem at all, and closing the loop. | ~35 min |
| [18. Mentor lifecycle: selection, replacement, offboarding](lesson-18-mentor-lifecycle.md) | E, Mentoring | Who is eligible to mentor and how to become eligible, choosing a balanced team and the common mistakes, how many mentors and at what strength, recognising when coverage has thinned, running a replacement, and what happens at graduation and retirement. | ~35 min |
