...
- **Reviews (sampled):** median reviewers/PR **—**  |  reviewer diversity (eff.#) **—**  |  PR author diversity (eff.#) **1.0**  |  unique reviewers **0**, unique authors **1**
...
- **Releases (from list votes/results):** 0  |  **Median gap (days):** —
- **New contributors:** 2  |  **Unique committers:** 3  |  **Commits:** 4
- **Issues:** opened 2 / closed 1
- **PRs:** opened 2 / merged 2  |  **Median merge time (days):** 0.0
- **Reviews (sampled):** median reviewers/PR **—**  |  reviewer diversity (eff.#) **1.0**  |  PR author diversity (eff.#) **2.0**  |  unique reviewers **1**, unique authors **2**
...
- **New contributors:** 5  |  **Unique committers:** 8  |  **Commits:** 32
- **Issues:** opened 30 / closed 9
- **PRs:** opened 28 / merged 22  |  **Median merge time (days):** 1.5
- **Reviews (sampled):** median reviewers/PR **—**  |  reviewer diversity (eff.#) **1.38**  |  PR author diversity (eff.#) **3.18**  |  unique reviewers **2**, unique authors **8**
- **Bus factor proxy (50% / 75%):** 1 / 2
- **Incubator reports:** 4  |  **Avg mentor sign-offs:** 1.5
- **Mailing lists:** dev messages **103**, dev unique posters **16**
