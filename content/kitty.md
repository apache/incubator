Title: Kitty Incubation Status
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

This page tracks the project status, incubator-wise. For more general project status, look on the project website.


<span class="retired">The Kitty project retired on 2012-10-19</span>


The Kitty Project is a lightweight, production focused, Java-based application server performance diagnostic and management utility.



- 2010-10-03 Project enters incubation.
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://incubator.apache.org/kitty/](http://incubator.apache.org/kitty/)  |
| . | wiki | . |
| Mailing list | dev |  `kitty-dev`  `@`  `incubator.apache.org`  |
| . | commits |  `kitty-commits`  `@`  `incubator.apache.org`  |
| . | user |  `kitty-user`  `@`  `incubator.apache.org`  |
| Bug tracking | . | [ provide expected link ] |
| Source code | SVN |  [https://svn.apache.org/repos/asf/incubator/kitty/](https://svn.apache.org/repos/asf/incubator/kitty/)  |
| Mentors | jim | Jim Jagielski |
| . | kevan | Kevan Miller |
| Committers | . | Matthew Sacks |
| . | . | Peary Chiu |
...
| date | item |
|------|------|
| 2010-10-03 | Identify all the Mentors for the incubation, by asking all that can be Mentors. |
|  | Jim Jagielski and Kevan Miller volunteered as mentors. Mark Thomas was identified as a mentor in the podling proposal. However, he was unaware of this and does not plan on mentoring the project. |
