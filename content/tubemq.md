Title: TubMQ Project Incubation Status
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

This page tracks the project status, incubator-wise. For more general project status, look on the project website.


TubeMQ is a trillion-records-scale distributed messaging queue (MQ) system, focuses on data transmission and storage under massive data.



- 2019-11-03 Project enters incubation.
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://tubemq.incubator.apache.org/](http://tubemq.incubator.apache.org/)  |
| . | wiki | . |
| Mailing list | dev |  `dev`  `@`  `tubemq.incubator.apache.org`  |
| . | commits |  `commits`  `@`  `tubemq.incubator.apache.org`  |
| Bug tracking | . | [ provide expected link ] |
| Source code | SVN |  [https://svn.apache.org/repos/asf/incubator/tubemq/](https://svn.apache.org/repos/asf/incubator/tubemq/)  |
| Roster | Whimsy |  [TubeMQ Roster](https://whimsy.apache.org/roster/ppmc/tubemq)  |


-  [TubeMQ Board Reports](https://whimsy.apache.org/board/minutes/tubemq.html) 
