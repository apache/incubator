Title: Gossip Project Incubation Status
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

<span class="retired">The Gossip podling retired on 2018-08-21</span>

.
Apache Gossip is an implementation of the Gossip Protocol



- 2016-04-28 Project enters incubation.

| item | type | reference |
|------|------|-----------|
| Website | www |  [http://gossip.incubator.apache.org/](http://gossip.incubator.apache.org/)  |
| . | wiki | . |
| Mailing list | dev |  `dev`  `@`  `gossip.incubator.apache.org`  |
| . | commits |  `commits`  `@`  `gossip.incubator.apache.org`  |
| Bug tracking | . |  [https://issues.apache.org/jira/browse/GOSSIP](https://issues.apache.org/jira/browse/GOSSIP)  |
| Source code | Git | https://gitbox.apache.org/repos/asf/incubator-gossip.git |
| Champion | ptgoetz | P. Taylor Goetz |
| Mentors | ptgoetz | P. Taylor Goetz |
| . | elserj | Josh Elser |
| . | drew | Drew Farris |
| Committers | ecapriolo | Edward Capriolo |
| . |  | Josh Clemm |
