...
<span class="retired">The AWF project retired on 2012-09-16</span>


AWF is a non-blocking, asynchronous, event driven high performance web framework running on the JVM.



- 2011-07-08 AWF has been accepted in Apache Incubator
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://incubator.apache.org/awf/](http://incubator.apache.org/awf/)  |
| . | wiki |  [https://cwiki.apache.org/confluence/display/AWF](https://cwiki.apache.org/confluence/display/AWF)  |
| Mailing list | dev |  `awf-dev`  `@`  `incubator.apache.org`  |
| . | users |  `awf-users`  `@`  `incubator.apache.org`  |
| . | commits |  `awf-commits`  `@`  `incubator.apache.org`  |
| Bug tracking | JIRA |  [https://issues.apache.org/jira/browse/AWF](https://issues.apache.org/jira/browse/AWF)  |
| Source code | SVN |  [https://svn.apache.org/repos/asf/incubator/awf/](https://svn.apache.org/repos/asf/incubator/awf/)  |
| Mentors | elecharny | Emmanuel Lecharny |
| . | mnour | Mohammad Nour El-Din |
| . | struberg | Mark Struberg |
| Committers | . | Roger Schildmeijer |
| . | . | Jim Petersson |
| . | . | Jonathan Meehan |
| . | . | Nicholas Whitehead |
| . | . | Seven Le Mesle |
...
| 2011-07-08 | Ask infrastructure to set up and archive mailing lists. |
| 2011-07-08 | Ask infrastructure to set up issue tracker (JIRA, Bugzilla). |
| 2011-07-08 | Ask infrastructure to set up wiki (Confluence, Moin). |
...
| 2011-07-10 | Tell Mentors to track progress in the file 'incubator/projects/awf.html' |
