...
<span class="retired">The Cotton project retired on 2015-12-01</span>


The Apache Cotton Project is an Apache Mesos framework for running MySQL instances.



- 2015-06-01 Project enters incubation.

- 2015-06-01 Project namesearch submitted: [PODLINGNAMESEARCH-78](https://issues.apache.org/jira/browse/PODLINGNAMESEARCH-78) 

- 2015-07-02 Project votes to be renamed Apache Cotton (incubating)

- 2015-12-01 Project votes to be retired from the Apache Incubator
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://cotton.incubator.apache.org/](http://cotton.incubator.apache.org/)  |
| . | wiki | . |
| Mailing list | dev |  `dev`  `@`  `cotton.incubator.apache.org`  |
| . | commits |  `commits`  `@`  `cotton.incubator.apache.org`  |
| Bug tracking | . | [ provide expected link ] |
| Source code | SVN |  [https://svn.apache.org/repos/asf/incubator/cotton/](https://svn.apache.org/repos/asf/incubator/cotton/)  |
...
| date | item |
|------|------|
| 2015-06-01 | Make sure that the requested project name does not already exist. [Please follow the guide to ensure a suitable project/product name.](http://www.apache.org/foundation/marks/naming.html)  |
...
| 2015-06-01 | Ask infrastructure to set up and archive mailing lists. |
