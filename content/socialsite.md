Title: Apache SocialSite Status Page
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

This page tracks the project status, incubator-wise. For more general project status, look on the project website.


<span class="retired">The SocialSite project retired on 2010-10-17</span>


The SocialSite Project is a wonderful project that does things and goes places.



- 2010-10-17 Enters retired state

- 2009-05-12 Incubation status page setup
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://incubator.apache.org/socialsite/](http://incubator.apache.org/socialsite/)  |
| . | wiki | . |
| Mailing list | dev |  `socialsite-dev`  `@`  `incubator.apache.org`  |
| . | commits |  `socialsite-commits`  `@`  `incubator.apache.org`  |
| Bug tracking | . | . |
| Source code | SVN | incubator/socialsite |
| Mentors | snoopdave | Dave Johnson |
| . | henning | Henning Schmiedehausen |
| Committers | ? | Bobby Bissett |
| . | ? | Rogrigo Gallardo |
| . | snoopdave | Dave Johnson |
| . | rameshm | Ramesh Mandava |
| . | ? | Leandro Milmanda |
| . | ? | Bruno Rovagnati |
| . | henning | Henning Schmiedehausen |
| . | ? | Jamey Wood |
...
This is the first phase on incubation, needed to start the project at Apache.
 ...
 _Item assignment is shown by the Apache id._  _Completed tasks are shown by the completion date_ 
