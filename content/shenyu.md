Title: ShenYu Project Incubation Status
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

This page tracks the project status, incubator-wise. For more general project status, look on the project website.


ShenYu is a high performance Microservices API gateway in Java ecosystem, compatible with a variety of mainstream framework systems, it supports hot plugins loading.



- 2021-05-03 Project enters incubation.
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://shenyu.apache.org/](http://shenyu.apache.org/)  |
| . | wiki | . |
| Mailing list | dev |  `dev`  `@`  `shenyu.apache.org`  |
| . | commits |  `commits`  `@`  `shenyu.apache.org`  |
| Bug tracking | . | [ provide expected link ] |
| Source code | . | . |
| incubator-shenyu |  [https://github.com/apache/incubator-shenyu](https://github.com/apache/incubator-shenyu/)  |
| incubator-dashboard |  [https://github.com/apache/incubator-shenyu-dashboard](https://github.com/apache/incubator-shenyu-dashboard)  |
| incubator-shenyu-website |  [https://github.com/apache/incubator-shenyu-website](https://github.com/apache/incubator-shenyu-website)  |
| Roster | Whimsy |  [ShenYu Roster](https://whimsy.apache.org/roster/ppmc/shenyu)  |


-  [ShenYu Board Reports](https://whimsy.apache.org/board/minutes/shenyu.html) 
...
| date | item |
|------|------|
| 2021-05-20 | Subscribe all Mentors on the pmc and general lists. |
