Title: Kyuubi Project Incubation Status
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

This page tracks the project status, incubator-wise. For more general project status, look on the project website.


Kyuubi is a distributed multi-tenant Thrift JDBC/ODBC server for large-scale data management, processing, and analytics, built on top of Apache Spark and designed to support more engines (i.e., Apache Flink).



- 2021-06-21 Project enters incubation.
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://kyuubi.apache.org/](http://kyuubi.apache.org/)  |
| . | wiki | . |
| Mailing list | dev |  `dev`  `@`  `kyuubi.apache.org`  |
| . | commits |  `commits`  `@`  `kyuubi.apache.org`  |
| . | private |  `private`  `@`  `kyuubi.apache.org`  |
| Bug tracking | . | using the github issues. |
| Source code | . | . |
| incubator-kyuubi |  [https://github.com/apache/incubator-kyuubi](https://github.com/apache/incubator-kyuubi/)  |
| incubator-kyuubi-website |  [https://github.com/apache/incubator-kyuubi-website](https://github.com/apache/incubator-kyuubi-website)  |
| Roster | Whimsy |  [Kyuubi Roster](https://whimsy.apache.org/roster/ppmc/kyuubi)  |


-  [Kyuubi Board Reports](https://whimsy.apache.org/board/minutes/kyuubi.html) 
