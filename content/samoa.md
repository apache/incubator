Title: SAMOA Incubation Status Page
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

This page tracks the project status, incubator-wise. For more general project status, look on the project website.


<span class="retired">The SAMOA podling retired on 2021-03-11</span>
...
- 2014-12-16 Project enters incubation.
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://samoa.incubator.apache.org/](http://samoa.incubator.apache.org/)  |
| . | wiki | . |
| Mailing list | dev |  `dev`  `@`  `samoa.incubator.apache.org`  |
| . | commits |  `commits`  `@`  `samoa.incubator.apache.org`  |
| Bug tracking | . |  [Jira: SAMOA](https://issues.apache.org/jira/browse/SAMOA)  |
| Source code | GIT |  [https://gitbox.apache.org/repos/asf/incubator-samoa.git](https://gitbox.apache.org/repos/asf/incubator-samoa.git)  |
| Champion | daijy | Daniel Dai |
| Mentors | gates | Alan Gates |
| . | hashutosh | Ashutosh Chauhan |
| . | enis | Enis Soztutar |
| . | tdunning | Ted Dunning |
| Committers | gdfm | Gianmarco De Francisci Morales |
