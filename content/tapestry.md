Title: Tapestry Incubation Status
<link href="http://purl.org/DC/elements/1.0/" rel="schema.DC"></link>

Tapestry has graduated - see http://tapestry.apache.org/


Please note: this page is incomplete; it is mainly a placeholder so standard Incubator links work OK.


<span class="graduated">The Tapestry project graduated on 2003-05-29</span>


The Tapestry Project develops a component-based web application framework.



- 2003-05-29 Project graduates to Jakarta

- 2003-04-01 Project enters incubation.


- http://incubator.apache.org/tapestry/
...
| item | type | reference |
|------|------|-----------|
| Website | www |  [http://incubator.apache.org/tapestry/](http://incubator.apache.org/tapestry/)  |
| . | wiki | . |
| Mailing list | dev |  `PROJECT-dev`  `@`  `incubator.apache.org`  |
| . | commits |  `PROJECT-commits`  `@`  `incubator.apache.org`  |
| Bug tracking | . | [ provide expected link ] |
| Source code | SVN |  [https://svn.apache.org/repos/asf/incubator/tapestry/](https://svn.apache.org/repos/asf/incubator/tapestry/)  |
| Mentors | . | Andrew C. Oliver |
| . | . | dIon Gillard |
| Committers | . | . |
| . | Mind Bridge |
| . | Neil Clayton |
